    ...
    <div class="p-6 space-y-8">
        ...
        <div class="p-4 bg-white rounded-lg shadow-md">
            <div class="space-y-2 w-full">
                <h2 class="text-2xl font-semibold text-teal-600">{{ $tipoCliente->nombre }} </h2>
                <p class="text-gray-700"><strong>Fecha de Creación:</strong>
                    {{ $tipoCliente->created_at->format('d/m/Y') }}</p>
                <p class="text-gray-700"><strong>Clientes Asociados: </strong> {{ $tipoCliente->clientes->count() }}
                    Clientes </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4">
            ...
            <p class="text-gray-600 mb-4">Gráfica de la cantidad de clientes asociados</p>
        ...
        <div class="bg-white rounded-lg shadow-md p-4">
            <div class="flex justify-between">
                <h3 class="text-xl font-semibold text-teal-600 p-2">Últimos Clientes Asociados</h3>
